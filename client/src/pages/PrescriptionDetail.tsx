...
import { PRESCRIPTIONS, PATIENTS, DOCTORS, MEDICINES, BRANCHES, fmtMoney } from "@/lib/demo-data";
      ...
      <Card className="print-page mx-auto max-w-[860px] p-10 border-card-border bg-white text-black dark:bg-card dark:text-foreground">
        <div className="flex items-start justify-between border-b-2 border-primary pb-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-[12px] text-muted-foreground">{branch.name} · {branch.address} · {branch.phone}</div>
            </div>
          </div>
          <div className="text-right text-[12px]">
            <div className="font-semibold text-[14px]">{d.fullName}</div>
              ...
              {r.items.map((it, i) => {
                ...
                return (
                  <tr key={i} className="border-b border-border/60">
                    ...
                    <td className="py-3"><div className="font-medium">{m.name}</div><div className="text-muted-foreground text-[11.5px]">{m.generic}</div></td>
        ...
        <div className="grid grid-cols-2 gap-6 pt-5 border-t border-border text-[12px]">
          ...
          <div className="text-right">
            ...
            <div className="text-[12px] font-medium">{d.fullName}</div>
        ...
        <div className="mt-6 pt-4 border-t border-border text-[10px] text-muted-foreground flex items-center justify-between">
          ...
          <span>This is a clinical demo document. Not for medical use.</span>
        </div>
      </Card>
    </PageContainer>
  );
